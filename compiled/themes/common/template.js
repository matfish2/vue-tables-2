  ...
  return h(
    ...
    [h(
      ...
      [h(
        ...
        [prependLimitContainer, dropdownPagination.call(this, h, modules.dropdownPagination), perPage.call(this, h, modules.perPage, classes), modules.columnsDropdown(), appendLimitContainer]
      )]
    ), beforeTable, h(
      'div',
      ...
      [h(
        ...
        [h(
          ...
          [prependHead, h(
            ...
            null,
            [modules.headings()]
          ), beforeFilters, modules.columnFilters(classes), afterFilters]
