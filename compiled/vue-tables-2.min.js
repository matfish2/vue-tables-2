...
var VueTables = function (t) {
  ...
  (function (t) {
    !function (e) {
      ...
      function n(t, e) {
        ...
        for (var r in e) {
          "object" === o(t[r]) && "object" === o(e[r]) ? t[r] = n(t[r], e[r]) : t[r] = e[r];
        }
      ...
      function i(t, e, i) {
        ...
        for (var u = 0; u < a; ++u) {
          var l = i[u];
          if ("object" === o(l)) for (var c in l) {
            if ("__proto__" !== c) {
              var f = t ? r.clone(l[c]) : l[c];
              s[c] = e ? n(s[c], f) : f;
            }
          }
        }
      ...
      r.recursive = function (t) {
        ...
        var e,
            ...
            i = t,
            s = o(t);
        if ("array" === s) for (i = [], n = t.length, e = 0; e < n; ++e) {
          i[e] = r.clone(t[e]);
        } else if ("object" === s) for (e in i = {}, t) {
          i[e] = r.clone(t[e]);
        }
        return i;
      }, e ? t.exports = r : window.merge = r;
    }(t && "object" == _typeof(t.exports) && t.exports);
  }).call(this, r(23)(t));
}, function (t, e, r) {
  "use strict";
  ...
  var i = new ((n = r(3)) && n.__esModule ? n : {
    "default": n
  })["default"]();
  e["default"] = i;
}, function (t, e) {
  function r(t, e, r) {
    ...
    function u() {
      var l = Date.now() - s;
      l < e && l >= 0 ? n = setTimeout(u, e - l) : (n = null, r || (a = t.apply(o, i), o = i = null));
    }
    ...
    var l = function l() {
      ...
      var l = r && !n;
      return n || (n = setTimeout(u, e)), l && (a = t.apply(o, i), o = i = null), a;
    };

    return l.clear = function () {
      n && (clearTimeout(n), n = null);
    }, l.flush = function () {
      n && (a = t.apply(o, i), o = i = null, clearTimeout(n), n = null);
    }, l;
  }
  ...
  Object.defineProperty(e, "__esModule", {
    ...
    return i["default"].recursive(!0, {
      ...
      methods: {
        ...
        orderByColumn: function orderByColumn(t, e) {
          if (this.sortable(t)) if (e.shiftKey && this.orderBy.column && this.hasMultiSort) this.setUserMultiSort(t);else {
            var r = {
              column: t,
              ascending: this.orderBy.column === t ? !this.orderBy.ascending : this._initialOrderAscending(t)
            };
            this.updateState("orderBy", r), this.commit("SORT", r), this.dispatch("sorted", r);
          }
        },
        ...
        setOrder: function setOrder(t, e) {
  ...
  function n() {
    for (var t = "", e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", r = 0; r < 5; r++) {
  ...
  t.exports = function (t) {
    t.vuex ? i(t) : t.limit = t.opts.perPage, n(t.opts.columnsDisplay) || "undefined" == typeof window || (t.columnsDisplay = function (t) {
      ...
      for (var a in t) {
        ...
        try {
          u = t[a], l = void 0, l = u.split("_"), r = l.length > 1 ? l[1] : l[0], e = o(r, n), i[a] = e.concat([n]);
        } catch (t) {
  ...
  t.exports = function (t, e) {
    var i = {
      ...
      bulma: r(109)()
        ...
        o = {
      "default": r(110),
      footerPagination: r(111)
    };
    return function (s) {
      var a = {
        rows: r(112).call(this, s),
        normalFilter: r(114).call(this, s),
        dropdownPagination: r(115).call(this, s),
        dropdownPaginationCount: r(116).call(this, s),
        columnFilters: r(117).call(this, s),
        pagination: r(121).call(this, s),
        headings: r(122).call(this, s),
        perPage: r(124).call(this, s),
        columnsDropdown: r(125).call(this, s)
      };
      if ("string" == typeof t && (!o[t] || "function" != typeof o[t])) throw 'vue-tables-2: Template "'.concat(t, '" does not exist');
      if ("string" == typeof e && (!i[e] || "object" !== n(i[e]))) throw 'vue-tables-2: Theme "'.concat(e, '" does not exist');
      var u = "string" == typeof t ? o[t] : t,
          l = "string" == typeof e ? i[e] : e(),
          c = r(128).call(this);
      return u.call(this, s, a, l, c);
    };
  };
}, function (t, e, r) {
  "use strict";
  ...
  t.exports = function (t, e) {
    if (e) {
      var r = this.query;
      this.setPage(1, !0);
      var a = this.getName(e.target.name),
          u = "object" === n(e.target.value) ? e.target.value : "" + e.target.value;
      a ? r[a] = u : r = u, this.vuex ? this.commit("SET_FILTER", r) : this.query = r, this.updateState("query", r), a ? (this.dispatch("filter", {
        name: a,
        value: u
      }), this.dispatch("filter::".concat(a), u)) : this.dispatch("filter", u);
    }
    ...
    if (this.opts.filterByColumn) {
      g = i(d);
      var m = this.customQueries;
      Object.keys(this.customQueries).forEach(function (t) {
        "" != m[t] && g--;
      });
    }

    t = s(t, this.opts.customFilters, this.customQueries);
    return g ? t.filter(function (t, e) {
      return l = 0, this.filterableColumns.forEach(function (e) {
        h = this.opts.dateColumns.indexOf(e) > -1 && this.opts.filterByColumn, p = this.isListFilter(e) && this.opts.filterByColumn, f = this.dateFormat(e), u = this._getValue(t, e), o(u) && !h && (u = u.format(f)), (c = function (t) {
          return t ? "string" == typeof t ? t.toLowerCase() : t : "";
        }(c = this.opts.filterByColumn ? d[e] : d)) && function t(e, r, i) {
          ["string", "number", "boolean"].indexOf(n(r)) > -1 && (r = String(r).toLowerCase());
          if (i) return r == e;
          if ("string" == typeof r) return r.indexOf(e) > -1;

          if (o(r)) {
            var s = moment(e.start, "YYYY-MM-DD HH:mm:ss"),
                a = moment(e.end, "YYYY-MM-DD HH:mm:ss");
            return r >= s && r <= a;
          }
  ...
  e.install = function (t, e, l) {
    var p = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "bootstrap3",
        d = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "default",
        g = s["default"].recursive(!0, (0, a["default"])(), {
      name: "client-table",
      components: {
        Pagination: n.Pagination
      },
      render: h.call(this, d, p),
      props: {
        columns: {
          type: Array,
          required: !0
      ...
      created: function created() {
        f(this), this.opts.toMomentFormat && this.transformDateStringsToMoment(), this.vuex || (this.initOrderBy(), this.query = this.initQuery(), this.customQueries = this.initCustomFilters());
      },
      ...
      data: function data() {
        return s["default"].recursive(c(), {
          source: "client",
          globalOptions: e,
          currentlySorting: {},
          time: Date.now()
        }, (0, u["default"])(l, "client", this.options.initialPage));
      },
      computed: {
        q: r(129),
        customQ: r(130),
      ...
      methods: {
        transformDateStringsToMoment: r(140),
        registerClientFilters: r(141),
        search: r(18),
        defaultSort: r(142),
        getGroupSlot: r(143),
        toggleGroup: function toggleGroup(t, e) {
          e.stopPropagation();
          var r = this.collapsedGroups.indexOf(t);
          r >= 0 ? this.collapsedGroups.splice(r, 1) : this.collapsedGroups.push(t);
        },
        groupToggleIcon: function groupToggleIcon(t) {
          var e = this.opts.sortIcon.base + " ";
          return e += this.collapsedGroups.indexOf(t) > -1 ? this.opts.sortIcon.down : this.opts.sortIcon.up;
        },
        ...
        m = l ? (0, i["default"])() : (0, o["default"])();
    return g = s["default"].recursive(g, m), t.component("v-client-table", g), g;
  };
}, function (t, e, r) {
  "use strict";
  ...
  t.exports = {
    ...
    created: function created() {
      if (this.vuex) {
        ...
        var t,
            ...
            r,
            n = this["for"];
        if (!this.$store.state[n]) this.$store.registerModule(this["for"], {
          state: {
            page: 1
          },
          mutations: (t = {}, e = n + "/PAGINATE", r = function r(t, e) {
            t.page = e;
    ...
    computed: {
      ...
      pages: function pages() {
        return this.records ? (t = this.paginationStart, e = this.pagesInCurrentChunk, Array.apply(0, Array(e)).map(function (e, r) {
          return r + t;
        })) : [];
        var t, e;
      },
    ...
    methods: {
      ...
      inDisplay: function inDisplay(t) {
  ...
  t.exports = function () {
    return function (t) {
      var e = this.Theme,
          ...
          i = "",
          o = "",
          s = this.pages.map(function (r) {
        return t("li", {
          "class": "VuePagination__pagination-item " + e.item + " " + this.activeClass(r),
          on: {
            click: this.setPage.bind(this, r)
          }
        }, [t("a", {
          "class": e.link + " " + this.activeClass(r),
          attrs: {
      ...
      return this.opts.edgeNavigation && this.totalChunks > 1 && (i = t("li", {
        "class": "VuePagination__pagination-item " + e.item + " " + (1 === this.page ? e.disabled : "") + " VuePagination__pagination-item-prev-chunk",
        on: {
      ...
      }, [this.opts.texts.first])]), o = t("li", {
        "class": "VuePagination__pagination-item " + e.item + " " + (this.page === this.totalPages ? e.disabled : "") + " VuePagination__pagination-item-prev-chunk",
        on: {
      ...
      }, [this.opts.texts.last])])), "fixed" === this.opts.chunksNavigation && (r = t("li", {
  ...
  t.exports = {
    initQuery: r(29),
    resetQuery: r(30),
    initCustomFilters: r(31),
    initOptions: r(32),
    sortableClass: r(33),
    sortableChevronClass: r(34),
    display: r(35),
    orderByColumn: r(36),
    getHeading: r(37),
    getHeadingTooltip: r(39),
    sortable: r(40),
    serverSearch: r(9),
    initOrderBy: r(41),
    initDateFilters: r(42),
    setFilter: r(43),
    setPage: r(44),
    setOrder: r(45),
    initPagination: r(46),
    ...
    rowWasClicked: r(57),
    setLimit: r(58),
    getOpenChildRows: r(59),
    dispatch: r(60),
    toggleChildRow: r(61),
    childRowTogglerClass: r(62),
    sendRequest: r(63),
    getResponseData: r(64),
    getSortFn: r(65),
    initState: r(66),
    updateState: r(67),
    columnClass: r(68),
    getName: r(69),
    toggleColumn: r(70),
    setUserMultiSort: r(71),
    _setFiltersDOM: r(72),
    _currentlySorted: r(73),
    _getChildRowTemplate: r(74),
    _toggleColumnsDropdown: r(75),
    _onlyColumn: r(76),
    _onPagination: r(77),
    _toggleGroupDirection: r(78),
    _getInitialDateRange: r(79),
    _setDatepickerText: r(80),
    _initialOrderAscending: r(81),
    dateFormat: r(82),
    _setColumnsDropdownCloseListener: r(83),
    _getValue: r(84),
    _getColumnName: r(85)
  };
}, function (t, e, r) {
  ...
  t.exports = function () {
    ...
    var e = {};
    return (this.opts.filterable && "object" == n(this.opts.filterable) ? this.opts.filterable : this.columns).forEach(function (r) {
      e[r] = function (t, e) {
  ...
  t.exports = function () {
    var t,
        e = {},
        r = this.opts.initFilters;
    return this.opts.customFilters.forEach(function (n) {
      t = "client" == this.source ? n.name : n, e[t] = r.hasOwnProperty(t) ? r[t] : "";
    }.bind(this)), e;
  };
}, function (t, e, r) {
  "use strict";
  ...
  t.exports = function () {
    if ("undefined" != typeof $ && void 0 !== $(this.$el).daterangepicker) {
      var t,
          ...
          r,
          i = this,
          o = this.vuex ? JSON.parse(JSON.stringify(this.query)) : this.query,
          s = function s(t, e) {
        return "client" == i.source ? i.search(i.data, e) : i.serverSearch(t, e);
      },
          a = n.recursive(this.opts.datepickerOptions, {
        autoUpdateInput: !1,
        singleDatePicker: !1
      });

      i.datepickerColumns.forEach(function (u) {
        var l = i._getInitialDateRange(u);

        l ? (i._setDatepickerText(u, l.start, l.end), l = {
          startDate: l.start,
          endDate: l.end
        }) : l = {}, t = $(i.$el).find("#VueTables__" + $.escapeSelector(u) + "-filter"), e = void 0 !== i.opts.datepickerPerColumnOptions[u] ? i.opts.datepickerPerColumnOptions[u] : {}, e = n.recursive(e, {
          locale: {
            format: i.dateFormat(u)
          }
        }), r = n(!0, a), !1 === e.ranges && (r.ranges = {}), t.daterangepicker(n.recursive(r, e, l)), t.on("apply.daterangepicker", function (t, e) {
          o[u] = {
            start: e.startDate.format("YYYY-MM-DD HH:mm:ss"),
            end: e.endDate.format("YYYY-MM-DD HH:mm:ss")
          }, i.vuex || (i.query = o), i._setDatepickerText(u, e.startDate, e.endDate), i.updateState("query", o), s(o, {
            target: {
              name: i._getColumnName(u),
              value: o[u]
            }
          });
        }), t.on("cancel.daterangepicker", function (t, e) {
          o[u] = "", i.vuex || (i.query = o), e.setStartDate(moment()), e.setEndDate(moment()), i.updateState("query", o), $(this).html("<span class='VueTables__filter-placeholder'>" + i.display("filterBy", {
            column: i.getHeading(u)
          }) + "</span>"), s(o, {
            target: {
              name: i._getColumnName(u),
              value: o[u]
  ...
  t.exports = function (t) {
    if (this.opts.filterable) {
      if (this.opts.filterByColumn && "string" == typeof t) console.warn("vue-tables-2: Unable to set filter. Filter value must be an object (`filterByColumn` is set to `true`)");else if (this.opts.filterByColumn || "string" == typeof t) {
  ...
  t.exports = function (t, e, r) {
    var n,
        i = this.opts.filterByColumn ? this.query[e] : this.query;
    return i ? r("span", {
    ...
    }(t, i = new RegExp("(" + ("string" == typeof (n = i) ? n.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&") : n) + ")", "i"), r)) : t;
  };
}, function (t, e, r) {
  "use strict";
  ...
  t.exports = function (t) {
    ...
    try {
      return t.map(function (t) {
        for (var r in t) {
          "client" === e.source && (t[r] = e.formatDate(t[r], e.dateFormat(r))), !e.isListFilter(r) || e.opts.templates[r] || e.$scopedSlots[r] || (t[r] = e.optionText(t[r], r));
        }

        return t;
      });
    } catch (e) {
      throw console.error("vue-tables-2: non-iterable data property. Expected array, got ".concat(n(t), ". Make sure that your response conforms to the expected format, or use the 'responseAdapter' option to match the currently returned format")), console.error("Data equals", t), new Error();
    }
  };
}, function (t, e, r) {
  "use strict";
  ...
  t.exports = function (t) {
    ...
    var n = this.userMultiSorting[e];
    if (e === t) !n.length || r ? this.orderBy.ascending = !this.orderBy.ascending : (this.orderBy = n.shift(), this.userMultiSorting = {}, this.userMultiSorting[this.orderBy.column] = n);else {
      var i = n.filter(function (e) {
        return e.column == t;
      })[0];
      i ? i.ascending ? i.ascending = !i.ascending : (this.userMultiSorting[e] = n.filter(function (e) {
        return e.column != t;
      }), this.userMultiSorting[e].length || (this.userMultiSorting = {})) : n.push({
        column: t,
        ascending: !0
      });
    }
  ...
  t.exports = function (t) {
    var e;
    if (this.opts.filterByColumn) for (var r in t) {
      var i = this._getColumnName(r);

      if (this.isDateFilter(r)) {
        if (t[r] && "object" === n(t[r])) {
          var o = "string" == typeof t[r].start ? moment(t[r].start, "YYYY-MM-DD") : t[r].start,
              s = "string" == typeof t[r].end ? moment(t[r].end, "YYYY-MM-DD") : t[r].end;

          this._setDatepickerText(r, o, s);
        } else $(this.$el).find("#VueTables__" + $.escapeSelector(r) + "-filter").html("<span class='VueTables__filter-placeholder'>" + this.display("filterBy", {
          column: this.getHeading(r)
        }) + "</span>");
      } else (e = this.$el.querySelector("[name='".concat(i, "']"))) ? e.value = t[r] : -1 === this.columns.indexOf(r) && console.error("vue-tables-2: Error in setting filter value. Column '".concat(r, "' does not exist."));
  ...
  t.exports = function (t, e, r) {
    ...
    ("string" == typeof t ? $(this.$el).find("#VueTables__" + $.escapeSelector(t) + "-filter") : t).text(e.format(n) + " - " + r.format(n));
  };
}, function (t, e, r) {
  "use strict";
  ...
  t.exports = {
    listColumnsObject: r(87),
    allColumns: r(88),
    templatesKeys: r(89),
    opts: r(90),
    tableData: r(92),
    storage: r(93),
    filterableColumns: r(94),
    datepickerColumns: r(95),
    hasChildRow: r(96),
    colspan: r(97),
    hasGenericFilter: r(98),
  ...
  t.exports = function () {
    ...
    }) : this.opts.ssr ? this.Columns : this.Columns.filter(function (r) {
      if (!e[r]) return !0;
      var n = e[r],
          i = n[2],
  ...
  t.exports = function () {
    return {
      ...
      sortingAlgorithm: function sortingAlgorithm(t, e) {
      ...
      showChildRowToggler: !0,
      uniqueKey: "id",
      requestFunction: !1,
      requestAdapter: function requestAdapter(t) {
        return t;
      },
  ...
  t.exports = function () {
    return !0 === this.opts.filterable ? this.opts.dateColumns : !1 === this.opts.filterable ? [] : n(this.opts.filterable, this.opts.dateColumns);
  };
}, function (t, e, r) {
  "use strict";
  ...
  t.exports = {
    ...
    update: function update(t, e, r, n) {}
  };
}, function (t, e, r) {
  "use strict";
  ...
  t.exports = function () {
    var t,
        e = this;
    this.opts.destroyEventBus && (i["default"].$off(), i["default"].$destroy()), this.vuex && !this.opts.preserveState && this.$store.unregisterModule(this.name), this.opts.filterByColumn && this.datepickerColumns.forEach(function (r) {
      (t = $(e.$el).find("#VueTables__" + $.escapeSelector(r) + "-filter").data("daterangepicker")) && t.remove();
    });
  };
}, function (t, e, r) {
  "use strict";
  ...
  Object.defineProperty(e, "__esModule", {
    ...
    if (void 0 !== t.$store.state[t.name]) return (0, i["default"])(!0, t.$store.state[t.name], e);
    return e;
  };
  var n,
      i = (n = r(0)) && n.__esModule ? n : {
  ...
  Object.defineProperty(e, "__esModule", {
    ...
    var e,
        r,
        n = "server" == t.source ? (o(e = {}, "".concat(t.name, "/SET_DATA"), function (e, r) {
      var n = t.opts.responseAdapter.call(t, r);
      e.data = n.data, e.count = parseInt(n.count);
    }), o(e, "".concat(t.name, "/LOADING"), function (t, e) {}), o(e, "".concat(t.name, "/LOADED"), function (t, e) {}), o(e, "".concat(t.name, "/ERROR"), function (t, e) {}), e) : o({}, "".concat(t.name, "/SET_COUNT"), function (t, e) {
      t.count = e;
    });
    return i["default"].recursive(!0, (o(r = {}, "".concat(t.name, "/PAGINATE"), function (e, r) {
      e.page = r, t.updateState("page", r), "server" == t.source && t.getData(), t.commit("PAGINATION", r);
    }), o(r, "".concat(t.name, "/SET_FILTER"), function (e, r) {
      e.page = 1, t.updateState("page", 1), e.query = r, "server" == t.source && t.getData();
    }), o(r, "".concat(t.name, "/PAGINATION"), function (t, e) {}), o(r, "".concat(t.name, "/SET_CUSTOM_FILTER"), function (e, r) {
      var n = r.filter,
          i = r.value;
      e.customQueries[n] = i, e.page = 1, t.updateState("page", 1), t.updateState("customQueries", e.customQueries), "server" == t.source && t.getData();
    }), o(r, "".concat(t.name, "/SET_STATE"), function (t, e) {
      var r = e.page,
          n = e.query,
          i = e.customQueries,
          o = e.limit,
    ...
    }), o(r, "".concat(t.name, "/SET_LIMIT"), function (e, r) {
      e.page = 1, t.updateState("page", 1), e.limit = r, "server" == t.source && t.getData();
    }), o(r, "".concat(t.name, "/SORT"), function (e, r) {
      var n = r.column,
          i = r.ascending;
      e.ascending = i, e.sortBy = n, "server" == t.source && t.getData();
    }), o(r, "".concat(t.name, "/SORTED"), function (t, e) {}), o(r, "".concat(t.name, "/ROW_CLICK"), function (t, e) {}), o(r, "".concat(t.name, "/FILTER"), function (t, e) {}), o(r, "".concat(t.name, "/LIMIT"), function (t, e) {}), r), n);
  };
  var n,
      i = (n = r(0)) && n.__esModule ? n : {
    "default": n
  ...
  t.exports = function (t, e, n, o) {
    var s = "VueTables__search_" + this.id,
    ...
    }, [this.display("limit")]), e.perPage(l, n.select, u)]) : "",
        h = this.opts.pagination && this.opts.pagination.dropdown ? t("div", {
      "class": "VueTables__pagination-wrapper"
    }, [t("div", {
      "class": "".concat(n.field, " ").concat(n.inline, " ").concat(n.right, " VueTables__dropdown-pagination"),
      directives: [{
        name: "show",
        value: this.totalPages > 1
      }]
      ...
      attrs: {
        ...
        p = this.opts.columnsDropdown ? t("div", {
      "class": "VueTables__columns-dropdown-wrapper"
    }, [e.columnsDropdown(n)]) : "",
        d = this.opts.footerHeadings ? t("tfoot", [t("tr", [e.headings(n.right)])]) : "",
        g = c || f || h || p || o.beforeFilter || o.afterFilter || o.beforeLimit || o.afterLimit,
        m = t("div", {
      "class": n.row,
      directives: [{
        name: "show",
      ...
      "class": "".concat(n.field, " ").concat(n.inline, " ").concat(n.left, " VueTables__search")
    }, [o.beforeFilter, c, o.afterFilter]), t("div", {
      "class": "".concat(n.field, " ").concat(n.inline, " ").concat(n.right, " VueTables__limit")
    }, [o.beforeLimit, f, o.afterLimit]), h, p])]);
    return t("div", {
      "class": "VueTables VueTables--" + this.source
    }, [m, o.beforeTable, t("div", {
      "class": "table-responsive"
    }, [t("table", {
      "class": "VueTables__table ".concat(this.opts.skin ? this.opts.skin : n.table)
    }, [t("thead", [o.prependHead, t("tr", [e.headings(n.right)]), o.beforeFilters, e.columnFilters(n), o.afterFilters]), d, o.beforeBody, t("tbody", [o.prependBody, e.rows(n), o.appendBody]), o.afterBody])]), o.afterTable, e.pagination((0, i["default"])(n.pagination, {
      wrapper: "".concat(n.row, " ").concat(n.column, " ").concat(n.contentCenter),
      nav: n.center,
      count: "".concat(n.center, " ").concat(n.column)
  ...
  t.exports = function (t, e, n, o) {
    var s = "VueTables__search_" + this.id,
      ...
      "class": "VueTables__columns-dropdown-wrapper"
        ...
        h = l || c || f || o.beforeFilter || o.afterFilter || o.beforeLimit || o.afterLimit,
        p = t("div", {
      "class": n.row,
      directives: [{
        name: "show",
      ...
      "class": "".concat(n.field, " ").concat(n.inline, " ").concat(n.right, " VueTables__limit")
    }, [o.beforeLimit, c, o.afterLimit]), f])]);
    return t("div", {
      "class": "VueTables VueTables--" + this.source
    }, [p, o.beforeTable, t("div", {
      "class": "table-responsive"
    }, [t("table", {
      "class": "VueTables__table ".concat(this.opts.skin ? this.opts.skin : n.table)
    }, [t("thead", [o.prependHead, t("tr", [e.headings(n.right)]), o.beforeFilters, e.columnFilters(n), o.afterFilters]), t("tfoot", [t("tr", [t("td", {
      attrs: {
        colspan: this.colspan
      }
    }, [e.pagination((0, i["default"])(n.pagination, {
      list: "".concat(n.pagination.list, " ").concat(n.right, " ").concat(n.nomargin),
      count: "".concat(n.left)
    }))])])]), o.beforeBody, t("tbody", [o.prependBody, e.rows(n), o.appendBody]), o.afterBody])]), o.afterTable]);
  };
}, function (t, e, r) {
  "use strict";

  var n,
      i = (n = r(113)) && n.__esModule ? n : {
    "default": n
  };
  ...
  t.exports = function (t) {
    ...
    return function (r) {
      ...
      if ("client" === e.source ? (n = e.filteredData).length || "client" !== e.source || 1 === e.page || e.setPage(e.totalPages ? e.totalPages : 1) : n = e.tableData, 0 === e.count) {
        e.allColumns.length;
        return e.hasChildRow && e.opts.showChildRowToggler && 0, t("tr", {
      ...
      var o,
          ...
          p = e.opts.uniqueKey,
          d = (e.Page - 1) * e.limit;
      return n.map(function (n, g) {
        if (e.opts.groupBy && "client" === e.source && n[e.opts.groupBy] !== u && (l = e.getGroupSlot(n[e.opts.groupBy]), c = n[e.opts.groupBy], f = e.opts.toggleGroups ? t("button", {
          "class": r.button,
          on: {
            click: e.toggleGroup.bind(e, c)
          }
        }, [c, t("span", {
          "class": e.groupToggleIcon(c)
        })]) : c, h.push(t("tr", {
          "class": r.groupTr,
          on: {
        ...
        }, [f, l])])), u = n[e.opts.groupBy]), !e.opts.toggleGroups || !e.collapsedGroups.includes(u)) {
          if (g = d + g + 1, o = [], e.hasChildRow && e.opts.showChildRowToggler) {
            var m = t("td", [t("span", {
              on: {
                click: e.toggleChildRow.bind(e, n[p])
              },
              "class": "VueTables__child-row-toggler " + e.childRowTogglerClass(n[p])
            })]);
            e.opts.childRowTogglerFirst && o.push(m);
          }

          e.allColumns.map(function (r) {
            var i = e.$scopedSlots && e.$scopedSlots[r];
            o.push(t("td", {
          ...
          }), e.hasChildRow && !e.opts.childRowTogglerFirst && e.opts.showChildRowToggler && o.push(m), a = e.opts.rowClassCallback ? e.opts.rowClassCallback(n) : "", s = e.opts.rowAttributesCallback ? e.opts.rowAttributesCallback(n) : {}, h.push(t("tr", (0, i["default"])([{
            attrs: s
          }, {
            "class": a,
            on: {
          ...
          }]), [o, " "])), h.push(e.hasChildRow && e.openChildRows.includes(n[p]) ? t("tr", {
  ...
  t.exports = function (t) {
    return t.reduce(function (t, e) {
      ...
      for (s in e) {
        if (i = t[s], o = e[s], i && r.test(s)) {
          if ("class" === s && ("string" == typeof i && (u = i, t[s] = i = {}, i[u] = !0), "string" == typeof o && (u = o, e[s] = o = {}, o[u] = !0)), "on" === s || "nativeOn" === s || "hook" === s) for (a in o) {
            i[a] = n(i[a], o[a]);
          } else if (Array.isArray(i)) t[s] = i.concat(o);else if (Array.isArray(o)) t[s] = [i].concat(o);else for (a in o) {
            i[a] = o[a];
          }
        } else t[s] = e[s];
      }
  ...
  t.exports = function (t) {
    var e = this;
    return function (r, i) {
      var o = "client" == e.source ? e.search.bind(e, e.data) : e.serverSearch.bind(e);
      return t("input", {
        "class": "".concat(r.input, " ").concat(r.small),
        attrs: {
          type: "text",
        ...
        on: {
          keyup: e.opts.debounce ? n(o, e.opts.debounce) : o
        }
      });
    };
  };
  ...
  t.exports = function (t) {
    var e = this;
    return function (r, n) {
      for (var i = [], o = 1; o <= e.totalPages; o++) {
        var s = e.page == o;
        i.push(t("option", {
          domProps: {
            value: o,
      ...
      return t("select", {
        "class": "".concat(r, " dropdown-pagination"),
        directives: [{
          name: "show",
    ...
    return function () {
      if (e.count > 0 && e.opts.pagination.dropdown) {
        var r = parseInt(e.limit),
            ...
            s = o[Math.min(1 == e.count ? 2 : 1 == e.totalPages ? 1 : 0, o.length - 1)].replace("{count}", e.count).replace("{from}", n).replace("{to}", i);
        return t("div", {
          "class": "VuePagination"
        }, [t("p", {
  ...
  t.exports = function (t) {
    ...
    return function (n) {
      ...
      var o = r(118).call(e, t, n.input),
          s = r(119).call(e, t),
          a = r(120).call(e, t, n.select),
          u = [];
      return e.hasChildRow && e.opts.childRowTogglerFirst && e.opts.showChildRowToggler && u.push(t("th")), e.allColumns.map(function (r) {
        var n = "";
        ...
        void 0 !== e.$slots["filter__".concat(r)] && (n = n ? t("div", [n, e.$slots["filter__".concat(r)]]) : e.$slots["filter__".concat(r)]), u.push(t("th", {
          "class": e.columnClass(r)
        }, [t("div", i({
          "class": "VueTables__column-filter"
        }, "class", "VueTables__" + r + "-filter-wrapper"), [n])]));
      }), e.hasChildRow && !e.opts.childRowTogglerFirst && e.opts.showChildRowToggler && u.push(t("th")), t("tr", {
  ...
  t.exports = function (t, e) {
    ...
    if (this.opts.debounce) var o = n(i, this.opts.debounce),
        s = function s(t) {
    ...
    return function (n) {
      return t("input", {
        on: {
          keyup: r.opts.debounce ? s : i
        },
        "class": e,
        attrs: {
          name: r._getColumnName(n),
          type: "text",
          placeholder: r.display("filterBy", {
            column: r.getHeading(n)
          })
        },
        domProps: {
          value: r.query[n]
  ...
  t.exports = function (t, e) {
    ...
    return function (n) {
      var i,
          o = [],
          s = "client" == r.source ? r.search.bind(r, r.data) : r.serverSearch.bind(r);
      return r.opts.listColumns[n].filter(function (t) {
        return !t.hide;
      }).map(function (e) {
        i = e.id == r.query[n] && "" !== r.query[n], o.push(t("option", {
          domProps: {
            value: e.id,
            selected: i
          }
  ...
  t.exports = function (t) {
    ...
    return function (r) {
      ...
      var n = {
        ...
        chunksNavigation: e.opts.pagination.nav,
        edgeNavigation: e.opts.pagination.edge,
        texts: {
          count: e.opts.texts.count,
          first: e.opts.texts.first,
          last: e.opts.texts.last
        }
      },
          i = e.vuex ? e.name : e.id;
      return t("pagination", {
        ref: "pagination",
        attrs: {
          options: n,
  ...
  t.exports = function (t) {
    ...
    return function (n) {
      var i = r(123)(t, n),
          o = [];
      return e.hasChildRow && e.opts.childRowTogglerFirst && e.opts.showChildRowToggler && o.push(t("th")), e.allColumns.map(function (e) {
        o.push(t("th", {
          on: {
      ...
      }.bind(e)), e.hasChildRow && !e.opts.childRowTogglerFirst && e.opts.showChildRowToggler && o.push(t("th")), o;
    };
  };
}, function (t, e, r) {
  "use strict";
  ...
  t.exports = function (t, e) {
    return function (r) {
      return this.sortable(r) ? t("span", {
        "class": "VueTables__sort-icon ".concat(e, " ").concat(this.sortableChevronClass(r))
      }) : "";
    };
  };
}, function (t, e, r) {
  ...
  t.exports = function (t) {
    ...
    return function (r) {
      ...
      return t("div", {
        ref: "columnsdropdown",
        "class": "".concat(r.dropdown.container, " ").concat(r.right, " VueTables__columns-dropdown")
      }, [t("button", {
        attrs: {
          type: "button"
        },
        "class": "".concat(r.button, " ").concat(r.dropdown.trigger),
        on: {
          click: e._toggleColumnsDropdown.bind(e)
        }
      }, [e.display("columns"), t("span", {
        "class": "".concat(r.icon, " ").concat(r.small)
      }, [t("i", {
  ...
  (function (e) {
    var r = function () {
      ...
      function o(s, u, l, c, f) {
        "object" == _typeof(u) && (l = u.depth, c = u.prototype, f = u.includeNonEnumerable, u = u.circular);
        var h = [],
            p = [],
            d = void 0 !== e;
        return void 0 === u && (u = !0), void 0 === l && (l = 1 / 0), function s(l, g) {
          if (null === l) return null;
          if (0 === g) return l;
          var m, y;
          if ("object" != _typeof(l)) return l;
          if (t(l, r)) m = new r();else if (t(l, n)) m = new n();else if (t(l, i)) m = new i(function (t, e) {
            l.then(function (e) {
              t(s(e, g - 1));
            }, function (t) {
              e(s(t, g - 1));
            });
          });else if (o.__isArray(l)) m = [];else if (o.__isRegExp(l)) m = new RegExp(l.source, a(l)), l.lastIndex && (m.lastIndex = l.lastIndex);else if (o.__isDate(l)) m = new Date(l.getTime());else {
            if (d && e.isBuffer(l)) return m = e.allocUnsafe ? e.allocUnsafe(l.length) : new e(l.length), l.copy(m), m;
            t(l, Error) ? m = Object.create(l) : void 0 === c ? (y = Object.getPrototypeOf(l), m = Object.create(y)) : (m = Object.create(c), y = c);
          }
          ...
          for (var b in t(l, r) && l.forEach(function (t, e) {
            var r = s(e, g - 1),
                n = s(t, g - 1);
            m.set(r, n);
            ...
            var w;
            y && (w = Object.getOwnPropertyDescriptor(y, b)), w && null == w.set || (m[b] = s(l[b], g - 1));
          }
          ...
          if (Object.getOwnPropertySymbols) {
            ...
            for (b = 0; b < _.length; b++) {
              var S = _[b];
              (!(x = Object.getOwnPropertyDescriptor(l, S)) || x.enumerable || f) && (m[S] = s(l[S], g - 1), x.enumerable || Object.defineProperty(m, S, {
                enumerable: !1
              }));
            }
          }
          ...
          if (f) {
            var C = Object.getOwnPropertyNames(l);

            for (b = 0; b < C.length; b++) {
              var x,
                  P = C[b];
              (x = Object.getOwnPropertyDescriptor(l, P)) && x.enumerable || (m[P] = s(l[P], g - 1), Object.defineProperty(m, P, {
                enumerable: !1
              }));
            }
          }
      ...
      }, o.__objToStr = s, o.__isDate = function (t) {
        return "object" == _typeof(t) && "[object Date]" === s(t);
      }, o.__isArray = function (t) {
        return "object" == _typeof(t) && "[object Array]" === s(t);
      }, o.__isRegExp = function (t) {
        return "object" == _typeof(t) && "[object RegExp]" === s(t);
      }, o.__getRegExpFlags = a, o;
    }();

    t.exports && (t.exports = r);
  }).call(this, r(135).Buffer);
}, function (t, e, r) {
  "use strict";
  ...
  (function (t) {
    ...
    function f(t, e) {
      if (c(e), t = a(t, e < 0 ? 0 : 0 | p(e)), !u.TYPED_ARRAY_SUPPORT) for (var r = 0; r < e; ++r) {
        t[r] = 0;
      }
      return t;
    }
    ...
    function T(t, e, r) {
      ...
      for (var n = [], i = e; i < r;) {
        ...
        if (i + f <= r) switch (f) {
          ...
          case 3:
            o = t[i + 1], s = t[i + 2], 128 == (192 & o) && 128 == (192 & s) && (u = (15 & l) << 12 | (63 & o) << 6 | 63 & s) > 2047 && (u < 55296 || u > 57343) && (c = u);
            break;

          case 4:
            o = t[i + 1], s = t[i + 2], a = t[i + 3], 128 == (192 & o) && 128 == (192 & s) && 128 == (192 & a) && (u = (15 & l) << 18 | (63 & o) << 12 | (63 & s) << 6 | 63 & a) > 65535 && u < 1114112 && (c = u);
        }
    ...
    e.Buffer = u, e.SlowBuffer = function (t) {
      ...
      for (var o = (i >>>= 0) - (n >>>= 0), s = (r >>>= 0) - (e >>>= 0), a = Math.min(o, s), l = this.slice(n, i), c = t.slice(e, r), f = 0; f < a; ++f) {
        if (l[f] !== c[f]) {
          o = l[f], s = c[f];
          break;
        }
    ...
    function I(t, e, r, n, o) {
      return o || $(t, 0, r, 4), i.write(t, e, r, n, 23, 4), r + 4;
    }

    function q(t, e, r, n, o) {
      return o || $(t, 0, r, 8), i.write(t, e, r, n, 52, 8), r + 8;
    }
    ...
    u.prototype.slice = function (t, e) {
      ...
      return t = +t, e |= 0, r || A(this, t, e, 2, 65535, 0), u.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : M(this, t, e, !0), e + 2;
    }, u.prototype.writeUInt16BE = function (t, e, r) {
      return t = +t, e |= 0, r || A(this, t, e, 2, 65535, 0), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : M(this, t, e, !1), e + 2;
    }, u.prototype.writeUInt32LE = function (t, e, r) {
      return t = +t, e |= 0, r || A(this, t, e, 4, 4294967295, 0), u.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : F(this, t, e, !0), e + 4;
    }, u.prototype.writeUInt32BE = function (t, e, r) {
      return t = +t, e |= 0, r || A(this, t, e, 4, 4294967295, 0), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : F(this, t, e, !1), e + 4;
      ...
      return t = +t, e |= 0, r || A(this, t, e, 2, 32767, -32768), u.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : M(this, t, e, !0), e + 2;
    }, u.prototype.writeInt16BE = function (t, e, r) {
      return t = +t, e |= 0, r || A(this, t, e, 2, 32767, -32768), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : M(this, t, e, !1), e + 2;
    }, u.prototype.writeInt32LE = function (t, e, r) {
      return t = +t, e |= 0, r || A(this, t, e, 4, 2147483647, -2147483648), u.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : F(this, t, e, !0), e + 4;
    }, u.prototype.writeInt32BE = function (t, e, r) {
      return t = +t, e |= 0, r || A(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : F(this, t, e, !1), e + 4;
  ...
  e.byteLength = function (t) {
    ...
    for (r = 0; r < f; r += 4) {
      e = i[t.charCodeAt(r)] << 18 | i[t.charCodeAt(r + 1)] << 12 | i[t.charCodeAt(r + 2)] << 6 | i[t.charCodeAt(r + 3)], u[c++] = e >> 16 & 255, u[c++] = e >> 8 & 255, u[c++] = 255 & e;
    }
  ...
  e.read = function (t, e, r, n, i) {
    ...
    for (f += h, o = p & (1 << -c) - 1, p >>= -c, c += a; c > 0; o = 256 * o + t[e + f], f += h, c -= 8) {
      ;
    }
    ...
    for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (a = isNaN(e) ? 1 : 0, s = c) : (s = Math.floor(Math.log(e) / Math.LN2), e * (u = Math.pow(2, -s)) < 1 && (s--, u *= 2), (e += s + f >= 1 ? h / u : h * Math.pow(2, 1 - f)) * u >= 2 && (s++, u /= 2), s + f >= c ? (a = 0, s = c) : s + f >= 1 ? (a = (e * u - 1) * Math.pow(2, i), s += f) : (a = e * Math.pow(2, f - 1) * Math.pow(2, i), s = 0)); i >= 8; t[r + p] = 255 & a, p += d, a /= 256, i -= 8) {
      ;
    }
  ...
  t.exports = function () {
    this.data.forEach(function (t, e) {
      this.opts.dateColumns.forEach(function (e) {
        t[e] = t[e] ? moment(t[e], this.opts.toMomentFormat) : "";
      }.bind(this));
    }.bind(this));
  };
}, function (t, e, r) {
  ...
  t.exports = function () {
    var t = this,
        e = "vue-tables";
    this.name && (e += "." + this.name), this.opts.customFilters.forEach(function (r) {
      i["default"].$off("".concat(e, ".filter::").concat(r.name)), i["default"].$on("".concat(e, ".filter::").concat(r.name), function (e) {
        t.customQueries[r.name] = e, t.updateState("customQueries", t.customQueries);
      });
    });
  };
}, function (t, e, r) {
  ...
  t.exports = function (t, e) {
    ...
    return function (a, u) {
      ...
      if ("string" == typeof c && (c = c.toLowerCase()), "string" == typeof f && (f = f.toLowerCase()), c === f && i && i[r + 1]) {
        var p = i[r + 1];
        return l = void 0 !== p.ascending ? p.ascending : p.matchDir ? o : !o, n(p.column, l, r + 1)(a, u);
      }
  ...
  t.exports = function (t) {
    if (this.$scopedSlots && this.$scopedSlots.__group_meta) {
      var e = this.opts.groupMeta.find(function (e) {
        return e.value === t;
      });
      return e ? this.$scopedSlots.__group_meta(e) : "";
    }
  ...
  e.install = function (t, e, l) {
    var p = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "bootstrap3",
        d = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "default",
        g = l ? (0, o["default"])("server") : (0, s["default"])(),
        m = n["default"].recursive(!0, (0, a["default"])(), {
      name: "server-table",
      components: {
      ...
      created: function created() {
        ...
        f(this), this.vuex || (this.query = this.initQuery(), this.initOrderBy(), this.customQueries = this.initCustomFilters()), this.opts.sendInitialRequest && (this.loadState(), this.getData(!0).then(function (t) {
      ...
      data: function data() {
        return n["default"].recursive(c(), {
          source: "server",
          loading: !0,
          lastKeyStrokeAt: !1,
          globalOptions: e
        }, (0, i["default"])(l, "server", this.options.initialPage));
      },
      methods: {
        refresh: r(145),
        getData: r(146),
    ...
    return t.component("v-server-table", m), m;
  };
}, function (t, e, r) {
  "use strict";
  ...
  t.exports = function (t) {
    var e,
        ...
        s = this.opts.requestKeys,
        a = (n(e = {}, s.query, this.filteredQuery), n(e, s.limit, this.limit), n(e, s.ascending, this.orderBy.ascending ? 1 : 0), n(e, s.page, this.page), n(e, s.byColumn, this.opts.filterByColumn ? 1 : 0), e);
    this.orderBy.hasOwnProperty("column") && this.orderBy.column && (a[s.orderBy] = this.orderBy.column), a = i(a, this.opts.params, this.customQueries, r), this.hasMultiSort && this.orderBy.column && this.userMultiSorting[this.orderBy.column] && (a.multiSort = this.userMultiSorting[this.orderBy.column]), a = this.opts.requestAdapter(a), o && this.dispatch("loading", a);
    var u = this.sendRequest(a);
    return t ? u : u.then(function (t) {
